...
title: Solved:TypeScript Jest "Cannot use import statement outside module"
authors: [unicop]
tags: [TypeScript, Jest, Modules]
---

## The Issue 🦚

Natively, jest works only with `CommonJS`, because it is a **[Nodejs based CLI](./index.md#what-javascript-based-technology-runs-what-module-systems)**, it means modules are in the form of `require`, and `exports`.
